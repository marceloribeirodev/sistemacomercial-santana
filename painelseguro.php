...
$sql2 = "SELECT count(*) as 'contadorPositivoTarifaBilheteiro' from resultadoBilheteiro as rb inner join usuario as u on rb.matriculaBilheteiro = u.matricula 
where rb.resultadoSeguro - rb.metaSeguro >= 0 and u.matricula = '{$matricula}' and MONTH(rb.dataResultado) = '{$mes}' AND YEAR(rb.dataResultado) = '{$ano}'";

// Contador Negativo de metas das tarifas com base no mês e ano selecionado
$sql3 = "SELECT count(*) as 'contadorNegativoTarifaBilheteiro' from resultadoBilheteiro as rb inner join usuario as u on rb.matriculaBilheteiro = u.matricula 
where rb.resultadoSeguro - rb.metaSeguro < 0 and u.matricula = '{$matricula}' and MONTH(rb.dataResultado) = '{$mes}' AND YEAR(rb.dataResultado) = '{$ano}'";
        ...
        <div class="container-fluid pt-2">
              ...
              <div class="card bg-success border-0 mb-3" >
                <div class="card-body p-2 text-white text-center">
                  ...
                  <h5 class="card-text"><small>Metas batidas: <?php
                    while ($resultado = $resulta2->fetch_array()){ echo $resultado['contadorPositivoTarifaBilheteiro']; }?></small></h5> 
                </div>
              </div>
            </div>
              ...
              <div class="card bg-warning border-0 mb-3">
                <div class="card-body p-2 text-white text-center rounded" style="background-color: #E14823;">
                  ...
                  <h5 class="card-text"><small>Metas Não batidas: <?php
                    while ($resultado = $resulta3->fetch_array()){ echo $resultado['contadorNegativoTarifaBilheteiro']; }?></small></h5> 
                </div>
              </div>
            </div>
              ...
              <div class="col px-2">
                <div class="card bg-dark border-0 mb-3">
                  <div class="card-body p-2 text-light text-center rounded" style="background-color: #DB8545;">
                    ...
                    <h5 class="card-text"><small>Tarifa</small></h5>
                  </div>
                </div>
              </div>
            </a>
          ...
          <div class="card-deck mb-3">
            <div class="card bg-light card-panel-content">
              <div class="card-body">
                <h4 class="card-title text-center">Resultado - Seguro</h4>
